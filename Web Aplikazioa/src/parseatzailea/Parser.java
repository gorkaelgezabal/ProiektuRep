...
//		HTML KODEKETAK
		...
		izen_norm = izen_norm.replace("&AACUTE;", "A");//Á
		izen_norm = izen_norm.replace("&EACUTE;", "E");//É
		izen_norm = izen_norm.replace("&IACUTE;", "I");//Í
		izen_norm = izen_norm.replace("&OACUTE;", "O");//Ó
		izen_norm = izen_norm.replace("&UACUTE;", "U");//Ú
		izen_norm = izen_norm.replace("&NTILDE;", "N");//Ñ
		izen_norm = izen_norm.replace("&UUML;", "U");//Ü
		
		izen_norm = izen_norm.replace("&AGRAVE;", "A");//À
		izen_norm = izen_norm.replace("&CCEDIL;", "C");//Ç
		izen_norm = izen_norm.replace("&EGRAVE;", "E");//È
		izen_norm = izen_norm.replace("&IUML;", "I");//Ï
		izen_norm = izen_norm.replace("&OGRAVE;", "E");//Ò
